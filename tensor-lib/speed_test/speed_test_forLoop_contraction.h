...
int constexpr speed_test_forLoop_contraction(){
    std::cout << "_________________START UNIT TEST:__FOR_LOOP_CONTRACTION_____________" << std::endl;
    ...
    std::cout << "_________________END UNIT TEST:__FOR_LOOP_CONTRACTION________________" << std::endl;
...
int constexpr speed_test_double_forLoop_contraction(){
    std::cout << "_________________START UNIT TEST:__DOUBLE_FOR_LOOP_CONTRACTION_____________" << std::endl;
    ...
    std::cout << "CONTRACTION_FOR_LOOP(nano sec) :" << count2 << std::endl;
    std::cout << "_______________END UNIT TEST:__DOUBLE_FOR_LOOP_CONTRACTION________________" << std::endl;
...
int constexpr speed_test_triple_forLoop_contraction(){
    std::cout << "_________________START UNIT TEST:__TRIPLE_FOR_LOOP_CONTRACTION_____________" << std::endl;
    ...
    std::cout << "CONTRACTION_FOR_LOOP(nano sec) :" << count2 << std::endl;
    std::cout << "______________END UNIT TEST:__TRIPLE_FOR_LOOP_CONTRACTION_______________" << std::endl;
