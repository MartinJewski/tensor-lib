...
namespace ranges
{
    ...
    namespace detail
    {
        struct to_container
        {
            ...
            friend constexpr auto operator|(Rng && rng,
            ...
            friend constexpr auto operator|(closure<MetaFn, fn<MetaFn>> (*)(to_container),
                                  Pipeable pipe)
        ...
        public:
            ...
            constexpr to_container_iterator() = default;
            template<typename OtherIt>
            constexpr to_container_iterator(OtherIt it)
              : it_(std::move(it))
            {}
        ...
        constexpr CPP_concept_fragment(has_allocator_type_, (Cont),
            ranges::type<typename Cont::allocator_type>
        );
        template<typename Cont>
        constexpr CPP_concept_bool has_allocator_type =
            CPP_fragment(detail::has_allocator_type_, Cont);

        template<typename Rng>
        constexpr CPP_concept_bool range_and_not_view =
            defer::range<Rng> && !defer::view_<Rng>;

        template<typename Rng, typename Cont>
        constexpr CPP_concept_fragment(convertible_to_cont_impl_frag_, (Rng, Cont),
        ...
        template<typename Rng, typename Cont>
        constexpr CPP_concept_bool convertible_to_cont_impl_ =
            range_and_not_view<Cont> && move_constructible<Cont> &&
            CPP_fragment(detail::convertible_to_cont_impl_frag_, Rng, Cont);

        template<typename Rng, typename Cont>
        constexpr CPP_concept_fragment(convertible_to_cont_cont_impl_frag_, (Rng, Cont),
        ...
        public:
            ...
            template<typename Rng>
            auto constexpr operator()(Rng && rng) const -> CPP_ret(container_t<MetaFn, Rng>)( //
                requires input_range<Rng> &&                                        //
