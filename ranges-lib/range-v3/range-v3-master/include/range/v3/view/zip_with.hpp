...
namespace ranges
{
    ...
    namespace detail
    {
        struct equal_to_
        {
            ...
            constexpr bool operator()(T const & t, U const & u) const
            {
        ...
        struct _advance_
        {
            ...
            constexpr auto operator()(I & i, Diff n) const -> CPP_ret(void)( //
    ...
    private:
        ...
        public:
            ...
            constexpr sentinel(detail::ignore_t,
        ...
        public:
            ...
            constexpr auto CPP_auto_fun(move_)(meta::index_sequence<Is...>)(const)
            (
        ...
        template<bool Const = true>
        constexpr auto end_cursor() const -> CPP_ret(end_cursor_t<Const>)( //
            requires Const && and_v<range<Rngs const>...> &&
                views::zippable_with<Fun, meta::if_c<Const, Rngs const>...>)
        {
            return {fun_, tuple_transform(rngs_, ranges::end)};
    ...
    public:
        constexpr iter_zip_with_view() = default;
    ...
    namespace views
    {
        struct iter_zip_with_fn
        {
            ...
            constexpr auto operator()(Fun fun, Rngs &&... rngs) const -> CPP_ret(
