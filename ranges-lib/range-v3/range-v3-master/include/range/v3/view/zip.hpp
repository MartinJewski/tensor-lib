...
namespace ranges
{
    ...
    namespace detail
    {
        struct indirect_zip_fn_
        {
            ...
            [[noreturn]] constexpr auto operator()(copy_tag, Its...) const
            ...
            // tuple reference
            template<typename... Its>
            constexpr auto operator()(Its const &... its) const
            ...
            template<typename... Its>
            constexpr auto operator()(move_tag, Its const &... its) const
            ...
            [[noreturn]]constexpr auto operator()(copy_tag, It1, It2) const
            ...
            // pair reference
            template<typename It1, typename It2>
            constexpr auto operator()(It1 const & it1, It2 const & it2) const noexcept(
            ...
            template<typename It1, typename It2>
            constexpr auto operator()(move_tag, It1 const & it1, It2 const & it2) const
    ...
    struct zip_view : iter_zip_with_view<detail::indirect_zip_fn_, Rngs...>
    {
        ...
        constexpr explicit zip_view(Rngs... rngs)
    ...
    namespace views
    {
        ...
        {
            template<typename... Rngs>
            constexpr auto operator()(Rngs &&... rngs) const -> CPP_ret(
                zip_view<all_t<Rngs>...>)( //
