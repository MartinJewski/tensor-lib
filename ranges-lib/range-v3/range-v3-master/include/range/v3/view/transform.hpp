...
namespace ranges
{
    ...
    namespace detail
    {
        ...
        constexpr CPP_concept_fragment(iter_transform_1_readable_, (Fun, Rng),
        ...
        template<typename Fun, typename Rng>
        constexpr CPP_concept_bool iter_transform_1_readable =
            CPP_fragment(detail::iter_transform_1_readable_, Fun, Rng);

        template<typename Fun, typename Rng1, typename Rng2>
        constexpr CPP_concept_fragment(iter_transform_2_readable_, (Fun, Rng1, Rng2),
        ...
        template<typename Fun, typename Rng1, typename Rng2>
        constexpr CPP_concept_bool iter_transform_2_readable =
    ...
    private:
        ...
        public:
            ...
            constexpr adaptor(fun_ref_ fun)
              : fun_(std::move(fun))
            {}
        ...
        constexpr auto begin_adaptor() const -> CPP_ret(adaptor<Const>)( //
    ...
    public:
        constexpr iter_transform_view() = default;
        constexpr iter_transform_view(Rng rng, Fun fun)
    ...
    struct transform_view : iter_transform_view<Rng, indirected<Fun>>
    {
        ...
        constexpr transform_view(Rng rng, Fun fun)
    ...
    private:
        ...
        public:
            ...
            constexpr sentinel(meta::const_if_c<Const, iter_transform2_view> * parent,
                     decltype(ranges::end))
        ...
        public:
            ...
            constexpr cursor(meta::const_if_c<Const, iter_transform2_view> * parent,
