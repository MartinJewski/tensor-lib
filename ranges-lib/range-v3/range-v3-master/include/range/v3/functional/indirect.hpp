...
namespace ranges
{
    ...
    public:
        constexpr indirected() = default;
        constexpr indirected(Fn fn)
          : fn_(std::move(fn))
        {}
        ...
        // clang-format off
        template<typename... Its>
        constexpr auto CPP_auto_fun(operator())(Its... its)
        (
            return invoke(fn_, *its...)
        )
        template<typename... Its>
        constexpr auto CPP_auto_fun(operator())(Its... its)(const)
        (
        ...
        // Rvalue reference
        template<typename... Its>
        constexpr auto CPP_auto_fun(operator())(move_tag, Its... its)
        (
            return static_cast<
        ...
        template<typename... Its>
        constexpr auto CPP_auto_fun(operator())(move_tag, Its... its)(const)
        (
            return static_cast<
